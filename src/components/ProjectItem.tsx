    ...
    <div className="mx-auto flex w-full flex-col lg:max-w-4xl xl:flex-row">
      ...
      >
        <img
          ...
          className="aspect-auto h-full w-full rounded-lg duration-500 hover:-translate-y-10 hover:scale-105"
        />
      </div>
      ...
      <div className="ml-4 mt-6 flex flex-[3] flex-col justify-center xl:mt-0">
        <div className="flex items-center gap-4 space-x-2">
          ...
          <a
            ...
            className={`rounded-full p-2 transition-all duration-500 hover:scale-125 ${
